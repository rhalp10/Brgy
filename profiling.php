      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="profiling.php"  data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" >Barangay Profile</a>
        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
          ...
          <h1>Residence Profile Management</h1>
          <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Residence Profile</a></li>
          ...
          <br><br>
           <table class="table table-bordered table-inverse">
               ...
               <tbody>
                  <tr>
                     <th scope="row">1</th>
                     <td colspan="1">Rhalp Darren</td>
                     <td colspan="1">Cabrera</td>
